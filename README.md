...
> ⚡ Built for internal projects — ready for the community.
...
- ⚙️ Artisan commands to scaffold Filament features fast
- 🎨 Custom UI components (buttons, badges, layouts, widgets)
- 📦 Built-in support for Filament themes and Tailwind customization
- 🧰 Helpers, macros, and reusable patterns for resources and forms
- 🔐 Integrations for policies, permissions, and user profiles
...
We follow Sikessem's [Code of Conduct][conduct-link] — please read it before contributing.

### 👥 [Contributing Guide][pr-link]

To learn how to get started, read our [Contributing Guide][pr-link].
...
We discuss ideas and proposals in [**Sikessem Discussions**][discuss-link].

## 🔐 Security Reports

If you discover a vulnerability, please contact [SIGUI Kessé Emmanuel](https://sigui.ci)
at [contact@sigui.ci](mailto:contact@sigui.ci). We respond quickly.
